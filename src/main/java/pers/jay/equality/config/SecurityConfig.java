package pers.jay.equality.config;
...
import pers.jay.equality.service.impl.MyPasswordEncoder;

/**
 * 参考网址： https://blog.csdn.net/XlxfyzsFdblj/article/details/82083443
 ...
 * 查找了很多文件，有用的还有有的，感谢他们的辛勤付出 Security配置文件，项目启动时就加载了
 * 
 * @author 程就人生
 *
 */
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authenticationProvider(authenticationProvider()).httpBasic()
				...
				.and().authorizeRequests().anyRequest().authenticated() // 必须授权才能访问
